 ...
 *
 * This script migrates existing FastPay data to the multi-tenant architecture:
 * 1. Creates a default "fastpay" tenant
...
const DEFAULT_TENANT_ID = 'fastpay'
const DEFAULT_TENANT_SLUG = 'fastpay'
const DEFAULT_SHOP_NAME = 'FastPay Shop'
...
async function migrate() {
  ...
  console.log('FastPay Multi-Tenant Migration')
  console.log('='.repeat(60))
  console.log('')
  ...
  try {
    ...
    console.log('='.repeat(60))
    console.log('\nNext steps:')
    console.log('1. Set DEFAULT_TENANT_ID=fastpay in .env for backward compatibility')
...
async function createDefaultTenant(db: Db): Promise<void> {
  ...
  const tenant: Tenant = {
    ...
    branding: {
      ...
      primaryColor: '#3B82F6',
      accentColor: '#10B981',
      welcomeMessage: 'Welcome to FastPay Shop!'
    },
    settings: {
      currency: 'RUB',
      language: 'ru',
