      ...
      <div className="px-4 py-6 max-w-3xl mx-auto">
        <div className="prose prose-sm dark:prose-invert max-w-none text-light-text dark:text-dark-text">
          ...
          <p className="mb-4 text-sm leading-relaxed">
            1.1. Настоящий документ является публичной офертой (далее — «Оферта») и определяет условия использования платформы FastPay (далее — «Платформа») для приобретения цифровых товаров.
          </p>
          <p className="mb-4 text-sm leading-relaxed">
          ...
          <p className="mb-4 text-sm leading-relaxed">
            2.1. <strong>Платформа</strong> — сервис FastPay, предоставляющий техническую возможность для совершения сделок между продавцами и покупателями цифровых товаров.
          </p>
          <p className="mb-4 text-sm leading-relaxed">
