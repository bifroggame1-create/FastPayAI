    ...
    sections: [
      {
        ...
        content: `FastPay — это маркетплейс цифровых товаров, работающий через Telegram Mini App. Используя наш сервис, вы соглашаетесь с настоящими условиями.
...
• Автоматическую доставку цифровых товаров`
      },
      {
        ...
        content: `Для использования FastPay необходим аккаунт Telegram. Вы несете ответственность за:
...
Подробнее о политике возвратов — в разделе "Возвраты и споры".`
      },
      {
        ...
        content: `На FastPay запрещено продавать:
• Нелегальный контент
...
• Любые товары, нарушающие законодательство РФ`
      },
      {
        ...
        content: `FastPay не несет ответственности за:
    ...
    sections: [
      {
        ...
        content: `FastPay is a digital goods marketplace operating through Telegram Mini App. By using our service, you agree to these terms.
...
• Automatic delivery of digital products`
      ...
      {
        title: '2. Account',
        content: `A Telegram account is required to use FastPay. You are responsible for:
...
More about refund policy in the "Refunds and Disputes" section.`
      },
      {
        ...
        content: `Selling the following is prohibited on FastPay:
• Illegal content
...
• Any goods violating Russian law`
      },
      {
        ...
        content: `FastPay is not responsible for:
