      ...
      <div className="px-4 py-4">
        {cart.length === 0 ? (
          ...
          <>
                ...
                >
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="p-2 text-[var(--app-destructive)] hover:bg-[var(--app-destructive)]/10 rounded-lg transition-colors"
                      aria-label="Удалить"
                    >
                  ...
                  {/* Quantity Controls */}
                  <div className="flex items-center justify-between mt-3 pt-3 border-t border-tg-separator">
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center rounded-lg bg-tg-bg border border-tg-separator text-tg-text"
                      >
                        -
                      </button>
                      <span className="w-8 text-center font-semibold text-tg-text" aria-label={`Количество: ${item.quantity}`}>
                        {item.quantity}
                      </span>
                      <button
                        onClick={() => updateCartQuantity(item.productId, item.quantity + 1, item.variantId)}
            ...
            <button
              onClick={clearCart}
              className="w-full py-2 text-[var(--app-destructive)] text-sm font-medium mb-6"
            >
              Очистить корзину
            </button>
            ...
            <div className="bg-tg-secondary-bg rounded-xl p-4 border border-tg-separator mb-4">
              <h3 className="font-semibold text-tg-text mb-3">
                Итого
              </h3>
              <div className="space-y-2">
                ...
                <div className="flex justify-between pt-2 border-t border-tg-separator">
            ...
            <button
              ...
              className="w-full py-4 bg-tg-button text-tg-button-text rounded-xl font-semibold text-lg transition-all active:scale-[0.98]"
            >
              Оформить заказ
            </button>
          </>
